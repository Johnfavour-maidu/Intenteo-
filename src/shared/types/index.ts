...
export const REMINDER_SOUNDS: ReminderSound[] = [
  { id: "default", name: "Default Intentéo", description: "The classic Intentéo notification sound", category: "digital" },
