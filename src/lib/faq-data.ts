...
export const faqData: FaqItem[] = [
  // ─── Getting Started ───
  {
    ...
    question: "What is Inteénteo?",
    answer: "Inteénteo is an intentional living platform that connects your purpose, vision, goals, tasks, habits, and reflection into a single system. It helps you move from what matters to what you do every day, so your actions align with the life you want to live.",
  ...
  },
  {
    ...
    category: "Getting Started",
    question: "Who is Inteénteo for?",
    answer: "Inteénteo is for anyone who wants to live with more intention — people who want to get clear about what matters, turn their values into meaningful goals, organize their days around priorities, and build habits that support who they want to become.",
  ...
  },
  {
    ...
    answer: "Create a free account, set your purpose, and start building your first vision. Inteénteo guides you through each step — from defining your purpose to setting goals, creating tasks, and building habits. You can be up and running in minutes.",
  ...
  },
  {
    ...
    category: "Getting Started",
    question: "Do I need an account to use Inteénteo?",
    answer: "Yes, you need a free account to use Inteénteo. Your account lets us save your data and sync it across your devices. Creating an account takes just a minute.",
  ...
  },
  {
    id: "is-intenteo-free",
    category: "Getting Started",
    question: "Is Inteénteo free?",
    answer: "Yes. Inteénteo is free to use with core features including purpose, vision, goals, tasks, habits, and journaling. No credit card required.",
  ...
  {
    id: "how-does-it-work",
    category: "Inteénteo & Intentional Living",
    question: "How does Inteénteo connect purpose to daily actions?",
    answer: "Inteénteo uses a layered framework: Purpose → Vision → Goals → Tasks → Habits → Reflection. Each layer informs the next. Your purpose shapes your vision, your vision drives your goals, your goals determine your daily tasks, your habits build consistency, and your reflections help you learn and grow.",
  ...
  },
  {
    ...
    category: "Inteénteo & Intentional Living",
    question: "What makes Inteénteo different from a traditional productivity app?",
    answer: "Traditional productivity apps focus on task completion. Inteénteo connects every action back to your purpose and vision. It's not about doing more — it's about doing what matters. The Intent Score measures how intentionally you lived, not just how much you accomplished.",
  ...
  },
  {
    ...
    category: "Inteénteo & Intentional Living",
    question: "What is the Inteénteo framework?",
    answer: "The Inteénteo framework is a six-stage system: Purpose, Vision, Goals, Tasks, Habits, and Reflection. It moves from your deepest values to your daily actions, creating a connected system for intentional living. Each stage builds on the previous one.",
  ...
  },
  {
    ...
    category: "Inteénteo & Intentional Living",
    question: "How do the different parts of Inteénteo work together?",
    answer: "Everything in Inteénteo is connected. Your purpose informs your visions, your visions drive your goals, your goals shape your tasks and habits, and your reflections feed back into your understanding. The Intent Score ties it all together into a single daily measure.",
  ...
  // ─── Features ───
  {
    id: "what-is-purpose",
    category: "Features",
    question: "What is Purpose in Inteénteo?",
    answer: "Your purpose is the guiding principle behind everything you do. It's the answer to why you exist and what matters most to you. In Inteénteo, your purpose serves as the foundation for all your visions, goals, and actions.",
  ...
  },
  {
    ...
    answer: "Goals are the measurable milestones that move you toward your vision. Each goal you set in Inteénteo can be linked to one or more visions, so you always know which bigger picture you're working toward.",
  ...
  },
  {
    ...
    answer: "Absolutely. Goals in Inteénteo are flexible. You can update, edit, reprioritize, or archive goals at any time. Your journey evolves, and Inteénteo is designed to evolve with it.",
  ...
  },
  {
    ...
    answer: "Tasks are the specific actions you take each day. In Inteénteo, tasks can be linked to your goals, so every action connects to something bigger. You can set due dates, priorities, and track completion.",
  ...
  },
  {
    ...
    answer: "Yes. Every task can be linked to one or more goals. This connection is what makes Inteénteo different — you always know why you're doing something and how it contributes to your bigger picture.",
  ...
  },
  {
    ...
    answer: "Yes. You can set priorities on your tasks to focus on what matters most each day. Inteénteo helps you surface the most important actions so you can spend your energy wisely.",
  ...
  },
  {
    ...
    answer: "Yes. Inteénteo helps you plan your day by surfacing tasks linked to your goals, showing your habit commitments, and calculating your daily Intent Score. You start each day with clarity on what matters.",
  ...
  },
  {
    ...
    answer: "Habits in Inteénteo are recurring actions that build consistency. You can set schedules (daily, weekly, custom), track streaks, monitor health, and see trends over time. Habits are linked to your goals and contribute to your Intent Score.",
  ...
  },
  {
    ...
    answer: "Yes. You can create any habit that supports your goals and lifestyle. Inteénteo provides templates and suggestions, but you have full flexibility to define habits that matter to you.",
  ...
  },
  {
    ...
    answer: "Habit streaks count consecutive completions based on your habit's schedule. If you set a daily habit and complete it every day, your streak grows. Missing a day resets the streak, but Inteénteo also offers a recovery system so one miss doesn't erase your progress.",
  ...
  },
  {
    ...
    answer: "At the end of each day, you can log a reflection entry with your mood, gratitude, and notes. Inteénteo helps you spot patterns between your habits, mood, and goal progress — turning experience into wisdom.",
  ...
  },
  {
    ...
    answer: "Yes. Inteénteo provides built-in reflection prompts, but you can also write freely or create your own prompts. The journal adapts to your reflection style.",
  ...
  // ─── Account & Privacy ───
  {
    ...
    answer: "Visit the Inteénteo website or download the app and tap Sign Up. You can create an account with your email address in just a minute.",
  ...
  },
  {
    ...
    answer: "You can delete your account from your account settings. Upon deletion, your data will be permanently removed from our systems. Since Inteénteo stores most data locally, you should also clear your browser data if desired.",
  ...
  },
  {
    ...
    answer: "We take your privacy seriously. Inteénteo primarily stores your data in your browser's local storage, meaning your data stays on your device. We do not sell your personal information. See our Privacy Policy for full details.",
  ...
  // ─── Mobile App ───
  {
    ...
    category: "Mobile App",
    question: "Is Inteénteo available on mobile?",
    answer: "Yes. Inteénteo is available as a mobile app for iOS and Android. You can also use Inteénteo directly from your web browser on any device.",
  ...
  },
  {
    ...
    category: "Mobile App",
    question: "Where can I download the Inteénteo app?",
    answer: "You can download Inteénteo from the App Store (iOS) or Google Play (Android). You can also use Inteénteo directly from your web browser at inteo.app.",
  ...
  },
  {
    ...
    answer: "Yes. Inteénteo is available as a web application that works in any modern browser. You can access it from your desktop, tablet, or phone.",
  ...
  },
  {
    ...
    category: "Mobile App",
    question: "Is Inteénteo available on Android?",
    answer: "Yes. Inteénteo is available for download on Google Play for Android devices.",
  ...
  },
  {
    ...
    category: "Mobile App",
    question: "Will Inteénteo be available on other platforms?",
  ...
  // ─── Billing & Subscription ───
  {
    ...
    question: "Does Inteénteo have paid plans?",
    answer: "Inteénteo is free to use with core features. We may offer premium features in the future, but the core intentional living experience will always remain accessible.",
