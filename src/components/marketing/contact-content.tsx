...
function ContactInfo() {
  ...
  const infoCards = [
    ...
    },
    {
      icon: Lightbulb,
      title: "Feedback",
      content: "Have an idea that could make Inteénteo better? We would love to hear it.",
    },
    {
      icon: HelpCircle,
      title: "FAQ",
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="mt-3 text-muted-foreground leading-relaxed">
            Whether you have a question about Inteénteo, want to share feedback, or simply want to say hello, send us a message.
          </p>
        </div>
