...
export function ShareControls({ title, url, className }: ShareControlsProps) {
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className={cn(
            ...
            "border border-[#1E0E6B]/15 text-[#1E0E6B] hover:bg-[#1E0E6B]/5",
        ...
        <button
          onClick={shareOnX}
          className="inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium border border-[#1E0E6B]/15 text-[#1E0E6B] hover:bg-[#1E0E6B]/5 transition-all duration-200"
        ...
        {hasNativeShare && (
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium bg-[#1E0E6B] text-white hover:bg-[#1E0E6B]/90 transition-all duration-200"
