...
const ARTICLES: Article[] = [
  ...
  { id: "reports-exports", title: "Understanding Reports & Exports", category: "Getting Started", content: "Reports & Exports is your reflection and analytics workspace. It provides overview stats, reports on goals/habits/visions, insights into your progress, and export tools for your data. Use it to review your intentional living system and generate reports." },
