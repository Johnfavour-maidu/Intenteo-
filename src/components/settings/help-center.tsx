...
const ARTICLES: Article[] = [
  { id: "create-goal", title: "How to create your first Goal", category: "Getting Started", content: "Goals help you track meaningful outcomes over time. To create a goal, navigate to the Visions & Goals page and tap the + button. Give your goal a clear title, set a target date, and optionally link it to habits or projects. You can track progress manually or let linked habits update it automatically. Goals with a health score above 75% are considered On Track." },
  ...
  { id: "journey-page", title: "Understanding My Journey", category: "Getting Started", content: "My Journey is a visual timeline of your growth. It shows milestone completions, streak achievements, goal breakthroughs, and habit consistency over time. The journey updates automatically as you use Intenteo." },
  { id: "life-vision", title: "Setting your Life Vision", category: "Getting Started", content: "Your Visions are defined in Visions & Goals > My Visions. Create multiple visions for different areas of your life (Career, Family, Finance, Health, Impact, etc.). Each vision can have a Vision Board with images, quotes, Bible verses, videos, links, and notes for inspiration. Link goals to visions to see how your actions connect to your long-term purpose." },
