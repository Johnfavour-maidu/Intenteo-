    ...
    topics: [
      ...
      },
      {
        ...
        content: [
          ...
          "Over time, these small actions build a life that reflects your values. That is the Inteénteo way. Purpose informs vision. Vision shapes goals. Goals drive daily actions.",
    ...
    topics: [
      ...
      },
      {
        ...
        content: [
          ...
          "The chain of connection is: Purpose informs Vision. Vision shapes Goals. Goals drive Daily Actions. This is the Inteénteo framework.",
        ],
      },
      {
