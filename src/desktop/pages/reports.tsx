      ...
      <div className="sticky top-0 z-20 bg-background/80 backdrop-blur-xl border-b">
        <div className="flex items-center gap-4 px-6 py-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground mt-0.5">Your reflection and analytics workspace</p>
          </div>
        </div>
      </div>
        ...
        <Section title="Exports" icon={Download}>
          ...
          <div className="mt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <ExportCard
                title="JSON Backup"
                description="Complete data backup of your entire Inteénteo workspace"
                icon={File}
                format=".json"
              />
            </div>
          ...
          <div className="mt-6">
            ...
            {hasData ? (
              ...
              <div className="text-center py-6 rounded-lg border border-dashed border-[#1E0E6B]/10">
                ...
                <p className="text-sm text-muted-foreground">Start using Inteénteo to generate reports</p>
