...
import { SettingsToastContainer, useSettingsToast } from "@/components/settings/settings-toast"
import { HelpCenter } from "@/components/settings/help-center"
import { ContactUs } from "@/components/settings/contact-us"
import { Community } from "@/components/settings/community"
import { AboutIntentéo } from "@/components/settings/about-intenteo"
import {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Customize your Intentéo experience</p>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={(v) => { setActiveTab(v as SettingsTab); if (v === "security") setOpenSection("auth") }} className="w-full">
        ...
        <TabsContent value="security" className="mt-6 space-y-4">
          ...
          <Section id="privacy" title="Privacy" isOpen={openSection === "privacy"} onToggle={() => toggleSection("privacy")}>
            <ToggleRow id="analytics" label="Allow anonymous analytics" desc="Help improve Intentéo with usage data" checked={secSettings.analyticsEnabled} onCheckedChange={(v) => {
        ...
        <TabsContent value="help" className="mt-6 space-y-4">
          ...
          <Section id="about" title="About Intentéo" isOpen={openSection === "about"} onToggle={() => toggleSection("about")}>
            <AboutIntentéo />
          </Section>
        </TabsContent>
      </Tabs>
      ...
      {deleteStep === 1 && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
          ...
          <div className="relative z-10 w-full max-w-sm mx-4 bg-background border border-border rounded-2xl shadow-2xl p-6 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">Deleting your Intentéo account will permanently remove your goals, tasks, habits, journals, reminders, settings, and all associated data.</p>
      ...
      {deleteStep === 3 && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
          ...
          <div className="relative z-10 w-full max-w-sm mx-4 bg-background border border-border rounded-2xl shadow-2xl p-6 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">This permanently deletes your Intentéo account and all data.</p>
