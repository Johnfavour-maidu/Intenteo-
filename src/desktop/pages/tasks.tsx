...
import { useUndoRedo } from "@/shared/hooks"
...
const TIME_PRESETS = [
  ...
  { value: "morning" as const, label: "Morning", desc: "06:00 â€“ 11:59" },
  { value: "afternoon" as const, label: "Afternoon", desc: "12:00 â€“ 16:59" },
  { value: "evening" as const, label: "Evening", desc: "17:00 â€“ 20:59" },
  { value: "night" as const, label: "Night", desc: "21:00 â€“ 05:59" },
...
function TimeRangePicker({
  ...
  onTimeRangeTypeChange: (v: TimeRange) => void
}) {
...
export function DesktopTasksPage() {
  ...
  const [formTimeRangeType, setFormTimeRangeType] = useState<TimeRange>("anytime")
  ...
  const [sortMode, setSortMode] = useState<TasksSortMode>("time-asc")
  const [formMonthlyRepeatMode, setFormMonthlyRepeatMode] = useState<MonthlyRepeatMode>("dayOfMonth")
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6 py-6">
        ...
        {/* Viewing Past Day Banner â€” below task list */}
      ...
      {(goal || task.contributionPercent !== undefined) && (
        <div className="mt-2 flex items-start gap-1.5 p-2 rounded-lg bg-primary/5 border border-primary/10">
          ...
          <p className="text-[10px] text-muted-foreground leading-snug">
            <span className="font-medium text-foreground">TÃ©o Suggests</span> â€” This task contributes approximately{" "}
    ...
    <div className="fixed inset-0 z-[60] bg-background flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-10 max-w-2xl mx-auto w-full">
        ...
        <div className="text-xs text-muted-foreground space-y-1 mb-8 text-center">
          <p>Estimated Duration: {task.estimatedDuration ? `${task.estimatedDuration}m` : "â€”"}</p>
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="p-3 rounded-xl bg-muted/40 border">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-[10px] text-muted-foreground uppercase tracking-wider font-medium">TÃ©o Reflection</span>
            </div>
