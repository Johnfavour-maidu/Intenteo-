...
import { VerticalView } from "@/components/habits/vertical-view"
import { ListView } from "@/components/habits/list-view"
import { useToast, ToastContainer } from "@/components/tasks/task-toast"
import { HabitAnalyticsDrawer } from "@/components/habits/habit-analytics-drawer"
import {
...
export function HabitsPage() {
  ...
  useEffect(() => { try { localStorage.setItem("intenteo-habits-view", activeView) } catch {} }, [activeView])
