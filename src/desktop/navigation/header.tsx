...
import { NotificationCenter, getUnreadCount } from "@/components/layout/notification-center"
            ...
            >
              {avatar ? (
                ...
                <div className="h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center">
                  <span className="text-xs font-bold text-primary">{name ? name.charAt(0).toUpperCase() : "U"}</span>
                </div>
              )}
